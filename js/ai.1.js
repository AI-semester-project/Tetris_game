function AI(heightWeight, linesWeight, holesWeight, bumpinessWeight){
    ...
    console.log("hi");
    console.log(heightWeight, linesWeight, holesWeight, bumpinessWeight)
    console.log("hi")
};
...
AI.prototype._best = function(grid, workingPieces, workingPieceIndex){
    ...
    for(var rotation = 0; rotation < 4; rotation++){
        ...
        while(grid.valid(_piece)){
            ...
            document.getElementById("currentscorepiece").innerHTML = score;
            document.getElementById("bestscorepiece").innerHTML = bestScore;

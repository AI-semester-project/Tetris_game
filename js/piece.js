...
Piece.fromIndex = function(index){
    ...
    switch (index){
        ...
        case 1: // J
            piece = new Piece([
                [0x0000AA, 0x000000, 0x000000],
                [0x0000AA, 0x0000AA, 0x0000AA],
                [0x000000, 0x000000, 0x000000]
            ]);
            break;
        case 2: // L
            piece = new Piece([
                [0x000000, 0x000000, 0x0000AA],
                [0x0000AA, 0x0000AA, 0x0000AA],
                [0x000000, 0x000000, 0x000000]
            ]);
            break;
        case 3: // Z
            piece = new Piece([
                [0x0000AA, 0x0000AA, 0x000000],
                [0x000000, 0x0000AA, 0x0000AA],
                [0x000000, 0x000000, 0x000000]
            ]);
            break;
        case 4: // S
